...
export class NitroMessages implements IMessageConfiguration
{
    ...
    private registerEvents(): void
    {
        ...
        this._events.set(IncomingHeader.RP_INVENTORY, RPInventoryEvent);
    ...
    private registerComposers(): void
    {
        ...
        // RP
        this._composers.set(OutgoingHeader.GET_RP_INVENTORY, GetRPInventoryComposer);
        this._composers.set(OutgoingHeader.EQUIP_RP_ITEM, EquipRPItemComposer);
        this._composers.set(OutgoingHeader.UNEQUIP_RP_ITEM, UnequipRPItemComposer);
