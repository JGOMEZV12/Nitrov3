...
export const CameraWidgetCheckoutView: FC<CameraWidgetCheckoutViewProps> = props =>
{
    ...
    return (
        <NitroCardView className="nitro-camera-checkout w-[320px]" theme="primary-slim">
            ...
            <NitroCardContentView>
                <div className="flex items-center justify-center">
                    { (displayUrl && displayUrl.length) &&
                        <LayoutImage className="picture-preview border w-[280px] h-[280px]" imageUrl={ displayUrl } /> }
                    { (!displayUrl || !displayUrl.length) &&
