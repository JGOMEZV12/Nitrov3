...
}>> = props =>
{
    ...
    return (
        <Flex alignItems="center" className="absolute bottom-[-5px] left-[-2px] bg-[rgba(20,20,20,.95)] border border-[solid] border-[#101010] [box-shadow:inset_2px_2px_rgba(255,255,255,.1),inset_-2px_-2px_rgba(255,255,255,.1)] rounded-[$border-radius] p-2" gap={ 2 } innerRef={ elementRef }>
            ...
            <div className="navigation-item relative nitro-icon icon-me-rooms cursor-pointer" onClick={ event => window.parent.sendMapa() } />
            ...
            <div className="navigation-item relative nitro-icon icon-me-macro cursor-pointer" onClick={ event => window.parent.postMessage({ type: 'openMacro' }, '*') } />
            { children }
        </Flex>
    );
};
