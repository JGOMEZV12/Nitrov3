...
<div style={{ 
                        ...
                        }} className="cursor-pointer nitro-icon icon-combat" title={LocalizeText('room.combat.button.text')} onClick={() => window.parent.app['sendData']('event_target', 'open,CombatMode', false, false)} />
                <div style={{ 
                            backgroundColor: window.parent.isPsv ? 'rgba(42, 148, 4, 0.69)' : 'rgba(0, 0, 0, 0.1)',
                        }} className="cursor-pointer nitro-icon icon-psvmode" title={LocalizeText('room.psvm.button.text')} onClick={() => window.parent.app['sendData']('event_psv', 'open,PSVMode', false, false)} />
                <div className="cursor-pointer nitro-icon icon-gang" title={LocalizeText('room.gang.button.text')} onClick={() => window.parent.app['sendData']('event_gang', 'open,GangsWindow', false, false)} />
                
                <div className="cursor-pointer nitro-icon icon-wanted" title={LocalizeText('room.wanted.button.text')} onClick={() => window.parent.app['sendData']('event_stats', 'open,WantedList', false, false)} />
                
				<div className="cursor-pointer nitro-icon icon-inventory2" title={LocalizeText('room.inventory.button.text')} onClick={() => CreateLinkEvent('inventory-rp/show')} />
